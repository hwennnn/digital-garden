...
[Problem Link](https://leetcode.com/problems/minimum-time-to-reach-destination-in-directed-graph/)
...
---
### Python3
``` py title='minimum-time-to-reach-destination-in-directed-graph'
class Solution:
